...
function showTabContent(tabName) {
  if (tabName === 'description') {
    document.getElementById('tabContentDescription').style.display = 'block';
    document.getElementById('tabContentStats').style.display = 'none';
    document.getElementById('tabDescription').classList.add('activ');
    document.getElementById('tabStats').classList.remove('activ');
  } else if (tabName === 'stats') {
    document.getElementById('tabContentDescription').style.display = 'none';
    document.getElementById('tabContentStats').style.display = 'block';
    document.getElementById('tabDescription').classList.remove('activ');
    document.getElementById('tabStats').classList.add('activ');
  }
}